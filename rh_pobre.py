...
class Pobre:
    ...
    def utilitario(self, ctx, *, name: str=None):
        ...
        if name is None:
            ...
            return
        tool = yield from get_search(name.replace(' ', '+'), "26", '0')
    ...
    def traducao(self, ctx, *, name: str=None):
        ...
        if name is None:
            ...
            return
        traducao = yield from get_search(name.replace(' ', '+'), "23", '0')
    ...
    def tutorial(self, ctx, *, name: str=None):
        ...
        if name is None:
            ...
            return
        traducao = yield from get_search(name.replace(' ', '+'), "19", '0')
        if traducao is None or len(traducao) == 0:
    ...
    @staticmethod
    def get_tutorial_embed(ctx, traducao, long):
